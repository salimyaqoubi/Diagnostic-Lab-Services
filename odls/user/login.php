...
<head>
	...
	<title>Diagnostic Lab Services - Login Page</title>
...
<body class="simple-page">
	...
	<div class="simple-page-wrap">
		<div class="simple-page-logo animated swing">
				...
				<span style="color: white">Diagnostic Lab Services</span>
			
		</div><!-- logo -->
		<div class="simple-page-form animated flipInY" id="login-form">
	<h4 class="form-title m-b-xl text-center">Sign In With Your Diagnostic Lab Services Account</h4>
